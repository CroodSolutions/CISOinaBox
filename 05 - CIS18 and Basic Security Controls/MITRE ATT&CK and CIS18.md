...
| Solution Category | What It Does | Leading Brands |
|---|---|---|
| Penetration Testing Services | Expert-led testing of networks, applications, and people | Bishop Fox, Rapid7, NetSPI, Coalfire, Cobalt |
...
| Red Team / Adversary Emulation | Simulates real threat actor TTPs against the environment | MITRE Caldera (open source), Atomic Red Team (open source), Cobalt Strike (Fortra), Brute Ratel |
| Attack Surface Management (ASM) | Discovers and tests the external attack surface continuously | Censys, Shodan, Mandiant ASM, CrowdStrike Falcon Surface |
