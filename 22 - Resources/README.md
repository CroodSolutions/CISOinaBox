...
| [CC13: CISO Village - "Making It Click - How To Build an Effective Security Strategy"](https://www.youtube.com/watch?v=ZUxtgvP83ZY) | CISO Village discussing the nuances of executive debt vs. technical debt, eliminiation of executive debt, etc.  |
| [CC13: CISO Village - "How I Quit Worrying About an Incident and Learned to Become a CISO"](https://www.youtube.com/watch?v=IbpLgRRW-4k) | Preston Callos reveals a playbook that moves one from "incident firefighter" to trusted security leader  |
...
| Link | Description | 
| --- | --- |
| [cmd.ms: The Microsoft Command Line!](https://cmd.ms/) | Use the power of your browser's address bar to quickly get to your favorite blade in Azure, Microsoft 365, Entra ID, Intune... |
| [MSPortals.io](https://msportals.io/?search=) | A comprehensive directory of all Microsoft Portals in one place  |
| [M365maps.com - Microsoft 365 Licensing Maps](https://m365maps.com/) | Compare all the licensing tiers and visualize what each Microsoft level has access to | 
| [Overview of Microsoft Billing](https://learn.microsoft.com/en-us/azure/cost-management-billing/cost-management-billing-overview) | Overview on Microsoft Billing structure  |
| [Microsoft Security Hub](https://learn.microsoft.com/en-us/security/) | Microsoft's hub for security | 
| [Azure Governance Documentation](https://learn.microsoft.com/en-us/azure/governance/) | Governance documentation for Azure platform  |
| [Identity and Access Management Documentation](https://learn.microsoft.com/en-us/windows-server/identity/identity-and-access) | Documentation for Identity and Access Management Tehcnologies | 
| [Office 365 for IT Pros](https://office365itpros.com/) | The ultimate guide to mastering Microsoft 365  |
| [DirTeam](https://dirteam.com/) | The Active Directory community is proud to present you with the DirTeam.com and ActiveDir.org Weblogs: A collection of weblogs written by a team of dedicated IT Professionals  |
| [Entra.news](https://entra.news/) | News and updates, podcasts on the Entra platform | 
